...
<html>
	...
	function checkLoginName(){
		...
		var flag = true;
		$.ajax({
			url:"${ctx}/user/loginnameajax.action",
			type:"get",
...
<form action="${ctx}/user/addoredit.action" id="userForm" method="post">
